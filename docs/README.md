...
> You're in the `docs/` folder. This is the home for all project documentation beyond the root README.
...
| File | Description |
|------|-------------|
| [CLAUDE.md](CLAUDE.md) | Claude Code context file -- project conventions, commands, gotchas |
| [Manual.md](Manual.md) | Full technical manual -- architecture deep dive, module reference, roadmap, performance notes |
| [TLDR.md](TLDR.md) | Manual.md in headline form -- scan in 60 seconds |
...
- **New to the project?** Start with [TLDR.md](TLDR.md), then [Manual.md](Manual.md)
- **Looking up a function?** Go to [man.md](man.md)
- **What does `make X` do?** Go to [make.md](make.md)
